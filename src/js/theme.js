...
;(function ($) {
  ...
  */
  ...
  function gorillyInit() {
    $(".ajax-submit").on("submit", function($event) {
      $event.preventDefault();
      if($($event.target).hasClass("prevent-default")) return
      console.log(event);
      $($event.target).addClass("prevent-default");
      $($event.target).children(".loading").addClass("show");
      $($event.target).children(".success-message").removeClass("show");
      $($event.target).children(".error-message").removeClass("show");
      ...
      $.ajax({
        ...
        $($event.target).children(".loading").removeClass("show");
        $($event.target).children(".success-message").addClass("show");
      }).fail(function() {
        $($event.target).children(".loading").removeClass("show");
        $($event.target).children(".error-message").addClass("show");
      }).always(function() {
        $($event.target).removeClass("prevent-default");
      });
    })
  }
